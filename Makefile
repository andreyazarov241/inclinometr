...
SOURCES = \
	__init__.py \
	inclinometr.py inclinometr_dialog.py

PLUGINNAME = inclinometr

PY_FILES = \
	__init__.py \
	inclinometr.py inclinometr_dialog.py

UI_FILES = inclinometr_dialog_base.ui
...
QGISDIR=C:\Users\Андрей\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
